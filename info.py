...
BOT_TOKEN = environ.get('BOT_TOKEN', '6468740696:AAHDOmblMCSEaMALq5zAMzuiin7Rm8GvBDo')
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
USERNAME = environ.get('USERNAME', 'https://telegram.me/TMR_DEVELOPER')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://tmr624062:5Bm5K02Z5PZMqtqa@cluster0.zy0l7qn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjautobot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Rahul')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002021784050'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/wam.jpg')

#this vars is for when heroku or koyeb acc get banned, then change this vars as your file to link bot name
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002021784050'))
URL = environ.get('URL', '')

# verify system vars
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002021784050'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001868502293')
